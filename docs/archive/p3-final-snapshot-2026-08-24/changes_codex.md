...
> **Historical change log.** Superseded by `docs/HANDOVER.md` and
> `docs/phases/phase3-writeup.md` on 2026-08-21. The pending-work and test-count sections below are
> retained as provenance for that session, not as current instructions.
